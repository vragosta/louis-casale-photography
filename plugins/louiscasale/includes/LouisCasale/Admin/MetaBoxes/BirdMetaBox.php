...
class BirdMetaBox {
	 ...
	 */
	function register() {
		add_action( 'add_meta_boxes', array( $this, 'louiscasale_bird_metaboxes' ) );
		add_action( 'save_post', array( $this, 'louiscasale_bird_save_data' ) );
	}
	 ...
	 * @return void
	 */
	function louiscasale_bird_metaboxes() {
		add_meta_box(
			'configuration',
			__( 'Configuration', 'louiscasale_com' ),
			array( $this, 'louiscasale_bird_callback' ),
			BIRD_POST_TYPE
		);
	}
	 ...
	 * @return void
	 */
	function louiscasale_bird_callback( $post ) {
	 ...
	 * @return void
	 */
	function louiscasale_bird_save_data( $post_id ) {
		/**
		 * We need to verify this came from our screen and with proper authorization,
		 * because the save_post action can be triggered at other times.
		 */
		if ( ! isset( $_POST['louiscasale_bird_nonce'] ) ) {
			return;
		}

		# Verify that the nonce is valid.
		if ( ! wp_verify_nonce( $_POST['louiscasale_bird_nonce'], 'louiscasale_bird_save_data' ) ) {
			return;
		}
